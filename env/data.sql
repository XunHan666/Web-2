...
-- Safely clean up old data (order matters for FK constraints)
...
(2, 'daddy',  '$2y$10$/sC4tJEmLaVgmcqiCngLNegSz9wRqJo4r9hHvkh6vA0xXO2rLFKZe', 'Librarian Dave', NULL, NULL, 2, 'active', '2026-04-26 10:43:49');
...
(1,1,'BC1-001','available'),(2,1,'BC1-002','available'),(3,1,'BC1-003','available'),(4,1,'BC1-004','available'),(5,1,'BC1-005','available'),
(6,2,'BC2-001','available'),(7,2,'BC2-002','borrowed'),(8,2,'BC2-003','available'),(9,2,'BC2-004','available'),(10,2,'BC2-005','available'),
...
(41,9,'BC9-001','borrowed'),(42,9,'BC9-002','borrowed'),(43,9,'BC9-003','available'),(44,9,'BC9-004','available'),(45,9,'BC9-005','available'),
(46,10,'BC10-001','borrowed'),(47,10,'BC10-002','available'),(48,10,'BC10-003','available'),(49,10,'BC10-004','available'),(50,10,'BC10-005','available'),
...
-- 10. Readers
INSERT INTO readers (id, name, phone, email, address, dob, gender, status, account_id, created_at) VALUES
(1,  'An Nguyen',   '0901234567', 'an.nguyen@gmail.com',  '123 Le Loi, HCMC',            '1995-05-15', 'male', 'active', NULL, '2026-04-26 10:04:05'),
(2,  'Binh Tran',   '0912345678', 'binh.tran@gmail.com',  '456 Tran Hung Dao, Hanoi',    '1990-08-20', 'male', 'active', NULL, '2026-04-26 10:04:05'),
(3,  'Dung Pham',   '0923456789', 'dung.pham@gmail.com',  '789 Nguyen Hue, HCMC',        '1998-11-10', 'male', 'active', NULL, '2026-04-26 10:04:05'),
(4,  'Hoa Vu',      '0934567890', 'hoa.vu@gmail.com',     '321 Pham Van Dong, Danang',   '1985-02-28', 'male', 'active', NULL, '2026-04-26 10:04:05'),
(5,  'Khoa Dang',   '0945678901', 'khoa.dang@gmail.com',  '654 Nguyen Van Linh, HCMC',   '2001-07-22', 'male', 'active', NULL, '2026-04-26 10:04:05'),
(6,  'Giang Do',    '0956789012', 'giang.do@gmail.com',   '987 Le Duan, Hue',            '1992-12-05', 'male', 'active', NULL, '2026-04-26 10:04:05'),
(7,  'Huong Bui',   '0967890156', 'huong.bui@gmail.com',  '654 Ba Trieu, Hanoi',         '1988-03-25', 'male', 'active', NULL, '2026-04-26 10:04:05'),
(8,  'Lam Truong',  '0978901234', 'lam.truong@gmail.com', '120 Nguyen Dinh Chieu, HCMC', '1996-09-15', 'male', 'active', NULL, '2026-04-26 10:04:05'),
(9,  'Minh Le',     '0989012345', 'minh.le@gmail.com',    '741 Tran Phu, Danang',        '1993-06-30', 'male', 'active', NULL, '2026-04-26 10:04:05'),
(10, 'Nhung Phan',  '0990123456', 'nhung.phan@gmail.com', '852 Ly Thuong Kiet, Hanoi',   '1999-01-12', 'male', 'active', NULL, '2026-04-26 10:04:05');
